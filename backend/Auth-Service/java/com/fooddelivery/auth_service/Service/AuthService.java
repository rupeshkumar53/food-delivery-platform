...
public class AuthService {
	...
	public AuthResponse register(RegisterRequest request) {
		...
		return new AuthResponse(token, user.getRole().name(), user.getName(), "Registration successful!");
	}
	...
	public AuthResponse login(LoginRequest request) {
		...
		return new AuthResponse(token, user.getRole().name(), user.getName(), "Login successful!");
	}
